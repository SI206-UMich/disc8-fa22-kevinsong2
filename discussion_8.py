...
def getLink(soup):
    link1 = soup.find('a', title = "List of American universities with Olympic medals")
    link2 = link1.get("href")
    return "https://en.wikipedia.org:" + link2
...
def getAdmissionsInfo2019(soup):
    title = soup.find('a', title = "College/school founding")
    dict = []
    dict[title] = title
    return dict
